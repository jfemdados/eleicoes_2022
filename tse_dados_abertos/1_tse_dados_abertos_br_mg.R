...
# E sumarizar aquela quantidade de seções tem uma probabilidade alta de dar um erro.
# Na Resultados por Município, parece tem summarizado 
# Na Base dos Dados e já deve ter tratado e não enorme...
